    ...
    @if ($showUserForm)
        <form wire:submit.prevent="submitForm">
            ...
            <div class="mt-4">
                ...
                <div class="flex gap-2 mt-2">
                    ...
                    <select wire:model="restaurantPhoneCode" id="restaurantPhoneCode"
                        class="block w-24 rounded-md border-gray-300 dark:bg-gray-700 dark:text-white dark:border-gray-600">
            ...
            <div class="grid items-center grid-cols-1 mt-4 gap-2">
                ...
                <button type="submit"
    class="w-full rounded-lg bg-purple-600 px-5 py-3 text-center text-sm font-semibold text-white hover:bg-purple-700">
    Continue
</button>            </div>
        </form>
    @endif
